...
# filenames = ['/home/ziletti/Documents/calc_nomadml/rot_inv_3d/results_paper/inclusion/pristine/' + item for item in filenames]
...
for filename in filenames:
    ...
    obj = mlab.contour3d(s, contours=50, vmin=0.0, vmax=None, opacity=0.5)
